...
try:
    ...
    # genai.configure(api_key="AQ.Ab8RN6KfrVxN0zKXEJMe6k17tM0sPbAIFw6hlgE3RT0vAFHzsw")
    st.error(
        "Chave API não configurada. Configure no Secrets do Streamlit Cloud ou no código.")
